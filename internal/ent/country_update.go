...
func (_u *CountryUpdate) AddBudgetIDs(ids ...int) *CountryUpdate {
	_u.mutation.AddBudgetIDs(ids...)
	return _u
}

// AddBudgets adds the "budgets" edges to the Budget entity.
func (_u *CountryUpdate) AddBudgets(v ...*Budget) *CountryUpdate {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_u *CountryUpdate) AddTransactionIDs(ids ...int) *CountryUpdate {
	_u.mutation.AddTransactionIDs(ids...)
	return _u
}

// AddTransactions adds the "transactions" edges to the Transaction entity.
func (_u *CountryUpdate) AddTransactions(v ...*Transaction) *CountryUpdate {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_u *CountryUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if _u.mutation.BudgetsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   country.BudgetsTable,
			Columns: []string{country.BudgetsColumn},
			Bidi:    false,
			Target: &sqlgraph.EdgeTarget{
...
// AddBudgetIDs adds the "budgets" edge to the Budget entity by IDs.
func (_u *CountryUpdateOne) AddBudgetIDs(ids ...int) *CountryUpdateOne {
	_u.mutation.AddBudgetIDs(ids...)
	return _u
}

// AddBudgets adds the "budgets" edges to the Budget entity.
func (_u *CountryUpdateOne) AddBudgets(v ...*Budget) *CountryUpdateOne {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// AddTransactionIDs adds the "transactions" edge to the Transaction entity by IDs.
func (_u *CountryUpdateOne) AddTransactionIDs(ids ...int) *CountryUpdateOne {
	_u.mutation.AddTransactionIDs(ids...)
	return _u
}

// AddTransactions adds the "transactions" edges to the Transaction entity.
func (_u *CountryUpdateOne) AddTransactions(v ...*Transaction) *CountryUpdateOne {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// ClearBudgets clears all "budgets" edges to the Budget entity.
func (_u *CountryUpdateOne) ClearBudgets() *CountryUpdateOne {
	_u.mutation.ClearBudgets()
	return _u
}

// RemoveBudgetIDs removes the "budgets" edge to Budget entities by IDs.
func (_u *CountryUpdateOne) RemoveBudgetIDs(ids ...int) *CountryUpdateOne {
	_u.mutation.RemoveBudgetIDs(ids...)
	return _u
}

// RemoveBudgets removes "budgets" edges to Budget entities.
func (_u *CountryUpdateOne) RemoveBudgets(v ...*Budget) *CountryUpdateOne {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// ClearTransactions clears all "transactions" edges to the Transaction entity.
func (_u *CountryUpdateOne) ClearTransactions() *CountryUpdateOne {
	_u.mutation.ClearTransactions()
	return _u
}

// RemoveTransactionIDs removes the "transactions" edge to Transaction entities by IDs.
func (_u *CountryUpdateOne) RemoveTransactionIDs(ids ...int) *CountryUpdateOne {
	_u.mutation.RemoveTransactionIDs(ids...)
	return _u
}

// RemoveTransactions removes "transactions" edges to Transaction entities.
func (_u *CountryUpdateOne) RemoveTransactions(v ...*Transaction) *CountryUpdateOne {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
