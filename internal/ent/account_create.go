...
func (_c *AccountCreate) SetNillableAccountType(v *account.AccountType) *AccountCreate {
	if v != nil {
		_c.SetAccountType(*v)
	}
	return _c
...
func (_c *AccountCreate) SetCountryID(id int) *AccountCreate {
	_c.mutation.SetCountryID(id)
	return _c
}

// SetCountry sets the "country" edge to the Country entity.
func (_c *AccountCreate) SetCountry(v *Country) *AccountCreate {
...
func (_c *AccountCreate) check() error {
	...
	if len(_c.mutation.CountryIDs()) == 0 {
		return &ValidationError{Name: "country", err: errors.New(`ent: missing required edge "Account.country"`)}
	}
