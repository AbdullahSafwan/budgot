...
func (_q *CountryQuery) Where(ps ...predicate.Country) *CountryQuery {
	_q.predicates = append(_q.predicates, ps...)
	return _q
}

// Limit the number of records to be returned by this query.
func (_q *CountryQuery) Limit(limit int) *CountryQuery {
	_q.ctx.Limit = &limit
	return _q
}

// Offset to start from.
func (_q *CountryQuery) Offset(offset int) *CountryQuery {
...
func (_q *CountryQuery) Unique(unique bool) *CountryQuery {
...
func (_q *CountryQuery) QueryBudgets() *BudgetQuery {
...
func (_q *CountryQuery) QueryTransactions() *TransactionQuery {
...
func (_q *CountryQuery) First(ctx context.Context) (*Country, error) {
...
func (_q *CountryQuery) FirstX(ctx context.Context) *Country {
...
func (_q *CountryQuery) FirstID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (_q *CountryQuery) FirstIDX(ctx context.Context) int {
...
func (_q *CountryQuery) Only(ctx context.Context) (*Country, error) {
...
func (_q *CountryQuery) OnlyX(ctx context.Context) *Country {
...
func (_q *CountryQuery) OnlyID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (_q *CountryQuery) OnlyIDX(ctx context.Context) int {
...
func (_q *CountryQuery) All(ctx context.Context) ([]*Country, error) {
	ctx = setContextOp(ctx, _q.ctx, ent.OpQueryAll)
	if err := _q.prepareQuery(ctx); err != nil {
		return nil, err
	}
	qr := querierAll[[]*Country, *CountryQuery]()
	return withInterceptors[[]*Country](ctx, _q, qr, _q.inters)
}

// AllX is like All, but panics if an error occurs.
func (_q *CountryQuery) AllX(ctx context.Context) []*Country {
...
func (_q *CountryQuery) IDs(ctx context.Context) (ids []int, err error) {
	if _q.ctx.Unique == nil && _q.path != nil {
		_q.Unique(true)
	}
	ctx = setContextOp(ctx, _q.ctx, ent.OpQueryIDs)
	if err = _q.Select(country.FieldID).Scan(ctx, &ids); err != nil {
		return nil, err
	}
	return ids, nil
}
...
func (_q *CountryQuery) IDsX(ctx context.Context) []int {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *CountryQuery) Count(ctx context.Context) (int, error) {
	ctx = setContextOp(ctx, _q.ctx, ent.OpQueryCount)
	if err := _q.prepareQuery(ctx); err != nil {
		return 0, err
	}
	return withInterceptors[int](ctx, _q, querierCount[*CountryQuery](), _q.inters)
}

// CountX is like Count, but panics if an error occurs.
func (_q *CountryQuery) CountX(ctx context.Context) int {
...
func (_q *CountryQuery) Exist(ctx context.Context) (bool, error) {
...
func (_q *CountryQuery) ExistX(ctx context.Context) bool {
...
func (_q *CountryQuery) Clone() *CountryQuery {
	if _q == nil {
		return nil
	}
	return &CountryQuery{
...
func (_q *CountryQuery) WithBudgets(opts ...func(*BudgetQuery)) *CountryQuery {
	query := (&BudgetClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *CountryQuery) WithTransactions(opts ...func(*TransactionQuery)) *CountryQuery {
	query := (&TransactionClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
func (_q *CountryQuery) GroupBy(field string, fields ...string) *CountryGroupBy {
	_q.ctx.Fields = append([]string{field}, fields...)
	grbuild := &CountryGroupBy{build: _q}
...
//		Scan(ctx, &v)
func (_q *CountryQuery) Select(fields ...string) *CountrySelect {
	_q.ctx.Fields = append(_q.ctx.Fields, fields...)
	sbuild := &CountrySelect{CountryQuery: _q}
...
func (_q *CountryQuery) Aggregate(fns ...AggregateFunc) *CountrySelect {
	return _q.Select().Aggregate(fns...)
}

func (_q *CountryQuery) prepareQuery(ctx context.Context) error {
...
func (_q *CountryQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Country, error) {
	...
	if query := _q.withTransactions; query != nil {
		if err := _q.loadTransactions(ctx, query, nodes,
			func(n *Country) { n.Edges.Transactions = []*Transaction{} },
			func(n *Country, e *Transaction) { n.Edges.Transactions = append(n.Edges.Transactions, e) }); err != nil {
			return nil, err
		}
	}
...
func (_q *CountryQuery) loadBudgets(ctx context.Context, query *BudgetQuery, nodes []*Country, init func(*Country), assign func(*Country, *Budget)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[int]*Country)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	query.Where(predicate.Budget(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(country.BudgetsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (_q *CountryQuery) loadTransactions(ctx context.Context, query *TransactionQuery, nodes []*Country, init func(*Country), assign func(*Country, *Transaction)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[int]*Country)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	query.Where(predicate.Transaction(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(country.TransactionsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (_q *CountryQuery) querySpec() *sqlgraph.QuerySpec {
...
func (_q *CountryQuery) sqlQuery(ctx context.Context) *sql.Selector {
...
func (_g *CountryGroupBy) Aggregate(fns ...AggregateFunc) *CountryGroupBy {
	_g.fns = append(_g.fns, fns...)
	return _g
}

// Scan applies the selector query and scans the result into the given value.
func (_g *CountryGroupBy) Scan(ctx context.Context, v any) error {
	ctx = setContextOp(ctx, _g.build.ctx, ent.OpQueryGroupBy)
	if err := _g.build.prepareQuery(ctx); err != nil {
		return err
	}
	return scanWithInterceptors[*CountryQuery, *CountryGroupBy](ctx, _g.build, _g, _g.build.inters, v)
}

func (_g *CountryGroupBy) sqlScan(ctx context.Context, root *CountryQuery, v any) error {
...
func (_s *CountrySelect) Aggregate(fns ...AggregateFunc) *CountrySelect {
	_s.fns = append(_s.fns, fns...)
	return _s
}

// Scan applies the selector query and scans the result into the given value.
func (_s *CountrySelect) Scan(ctx context.Context, v any) error {
	ctx = setContextOp(ctx, _s.ctx, ent.OpQuerySelect)
	if err := _s.prepareQuery(ctx); err != nil {
		return err
	}
	return scanWithInterceptors[*CountryQuery, *CountrySelect](ctx, _s.CountryQuery, _s, _s.inters, v)
}

func (_s *CountrySelect) sqlScan(ctx context.Context, root *CountryQuery, v any) error {
