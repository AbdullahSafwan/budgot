...
func HasAccounts() predicate.Country {
...
func HasAccountsWith(preds ...predicate.Account) predicate.Country {
	return predicate.Country(func(s *sql.Selector) {
...
func HasBudgets() predicate.Country {
	return predicate.Country(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasBudgetsWith(preds ...predicate.Budget) predicate.Country {
	return predicate.Country(func(s *sql.Selector) {
		step := newBudgetsStep()
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {
...
func HasTransactions() predicate.Country {
	return predicate.Country(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasTransactionsWith(preds ...predicate.Transaction) predicate.Country {
	return predicate.Country(func(s *sql.Selector) {
