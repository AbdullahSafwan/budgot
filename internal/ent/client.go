...
func (c *Client) Use(hooks ...Hook) {
	for _, n := range []interface{ Use(...Hook) }{
		c.Account, c.Country, c.Currency, c.LoginAttempt, c.Session, c.User,
	} {
		n.Use(hooks...)
	}
}
...
type (
	hooks struct {
		Account, Country, Currency, LoginAttempt, Session, User []ent.Hook
	}
	inters struct {
		Account, Country, Currency, LoginAttempt, Session, User []ent.Interceptor
	}
)
